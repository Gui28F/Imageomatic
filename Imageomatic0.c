...
Código oferecido por professores de LAP 2020-2021
	...
	switch( c0 ) {
		...
		case 'Q':
			...
			&& validateImage('A') ) {
				...
				imageStore("img/cinzento.png", ic, na);
			}
			break;
		case 'N':
			...
			&& validateImage('A') ) {
				...
				na = imageCopy(ic, nc, ia);
				imageStore("img/negativo.png", ic, na);
			}
			break;
		case 'H':
			...
			&& validateImage('A') ) {
				...
				na = imageCopy(ic, nc, ia);
				imageStore("img/metade.png", ic, na);
			}
			break;
		case 'P':
			...
			&& validateIntY(parts[3]) ) {
				...
				imageStore("img/paint.png", ia, na);
			}
			break;
		case 'R':
			...
			&& validateImage('A') ) {
				...
				na = imageCopy(ic, nc, ia);
				imageStore("img/rotate.png", ia, na);
			}
			break;
		case 'O':
			...
			&& validateImage('A') ) {
				...
				na = imageCopy(ic, nc, ia);
				imageStore("img/posterize.png", ia, na);
			}
			break;
		case 'G':
			...
			&& validateIntY(parts[2]) ) {
				...
				imageStore("img/droplet.png", ia, na);
			}
			break;
		case 'D':
		...
		case 'F':
			...
			&& validateInt(parts[3], INT_INFINITE) ) {
				...
				na = imageFunctionPlotting(cos, stringToInt(parts[3]), n, ia);
				imageStore("img/graph.png", ia, na);
			}
			break;
		case 'T':
		...
		case 'E':
			...
			&& validateImage('A') ) {
				...
				na = imageCopy(ic, nc, ia);
				imageStore("img/hide.png", ia, na);
			}
			break;
		case 'U':
				nc = revImageSteganography(ia, na, s);
				printf("%s\n", s);
				break;
		case '!':
